...
int main(void) {
    ...
    //    srand(time(NULL));        // uses seconds | its random but if you run it within one second it returns the same
    //    thing
    ...
    if ((rand_num % 2) == 1) {
        printf("It's Heads\n");
        // printf("i would put an ASCII art here but idfk how to have C not hate that and force me into spamming /n and
        // \ all over the place");
    } else {
        printf("It's Tails\n");
