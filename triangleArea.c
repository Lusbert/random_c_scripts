...
double triArea(double *base, double *height) { return (*base * *height) / 2; }
double triAreaGamma(double *line_a, double *line_b,
                    double *gamma) { // i have no idea if this works or not, cause idk gamma and shit
    return (1 / 2) * *line_a * *line_b *
           (sin((PI * *gamma) / 180)); // i would test it but idk what to input and google doesnt help
}
